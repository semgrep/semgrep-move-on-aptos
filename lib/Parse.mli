...
(**
    Functions for parsing move_on_aptos programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a move_on_aptos program from a string into a typed OCaml CST.
...
(** Parse a move_on_aptos program from a file into a typed OCaml CST.
